...
class SwinU(nn.Module):
    ...
    Args:
        ...
        noise_dim (int): Noise dimension. Default: 128
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.norm = ConditionalLayerNorm(self.num_features, noise_dim)
        self.norm_up = ConditionalLayerNorm(self.embed_dim, noise_dim)
    ...
    def forward(self, x, noise_embedding):
        ...
        x = self.norm(x, noise_embedding)  # B L C
        ...
        for inx, layer_up in enumerate(self.layers_up):
            if inx == 0:
                ...
                x = layer_up(x, noise_embedding)

        x = self.norm_up(x, noise_embedding)  # B L C
